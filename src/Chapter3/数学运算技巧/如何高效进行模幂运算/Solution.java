package Chapter3.数学运算技巧.如何高效进行模幂运算;
...
public class Solution {
    ...
    public int dfs(int a, Deque<Integer> stack) {
        if (stack.isEmpty()) {
            return 1;
        }
        ...
        int part2 = myPow(dfs(a, stack), 10);
